...
It can also insert h5sph objects comming
...
Simple initializations can be automatically performed by \cmd{XProblem}, inparticular to prescribe an initial
