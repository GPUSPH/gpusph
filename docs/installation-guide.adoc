...
* httsp:/www.asciidoctor.org[AsciiDoctor] to build the documentation.
...
NOTE: this will fetch the latest (possibly experimental) version of Thrust.
You may also run `scripts/get-thrust` from the GPUSPH working directory
to fetch a known stable version of the library.
...
If you have https:://www.asciidoctor.org[AsciiDoctor] installed,
you can build the documentation locally using
[source,shell]
----
make docs
----
This will make the <<installation-guide.adoc#,Installation Guide>>
available under `docs/installation-guide.html`, and the
<<user-guide.adoc#,User Guide>>
available under `docs/user-guide.html`.
These are plain HTML files that you can read using your preferred web browser.
