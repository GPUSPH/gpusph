...
{
	using element_type = writable_type<writable, float2>;
	...
	element_type* __restrict__ vertPos0;
	element_type* __restrict__ vertPos1;
	element_type* __restrict__ vertPos2;
...
struct tau_params
{
	...
	element_type* __restrict__ tau0;
	element_type* __restrict__ tau1;
	element_type* __restrict__ tau2;
