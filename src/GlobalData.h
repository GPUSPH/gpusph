...
#define BUFFER_FORCE_NORMS	(1U << 10)
#define BUFFER_NEIBSLIST	(1U << 11)
#define BUFFER_HASH	(1U << 12)
#define BUFFER_PARTINDEX	(1U << 13)
#define BUFFER_CELLSTART	(1U << 14)
#define BUFFER_CELLEND	(1U << 15)
#define BUFFER_BOUNDELEMENTS	(1U << 16)
#define BUFFER_GRADGAMMA	(1U << 17)
#define BUFFER_VERTICES	(1U << 18)
#define BUFFER_PRESSURE	(1U << 19)
#define BUFFER_TKE	(1U << 20)
#define BUFFER_EPSILON	(1U << 21)
#define BUFFER_TURBVISC	(1U << 22)
#define BUFFER_STRAIN_RATE	(1U << 23)
